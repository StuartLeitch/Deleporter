...
namespace WhatTimeIsIt.SeleniumSelfHost.IntegrationTest.Infrastructure
{
    /// <summary>
    ...
    public static class DriverFactory
    {
        ...
        public static bool KeepDriverForAllTests { get; set; }

        /// <summary>
        /// Disposes of Driver if KeepDriverForAllTests is not true
        /// </summary>
        public static void GetNewDriverForTestIfNewDriverSet() {
            if (!KeepDriverForAllTests) {
                DisposeDriver();
            }
        }
